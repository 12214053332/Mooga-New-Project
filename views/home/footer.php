    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <h2>عنا</h2>
          <hr>
          <p class="about-lt">موقع موجة هو أحد المواقع التابعة لشركة المؤشر للبرمجيات والتى تتواجد فى السوق المصرى من عام 2002 كأحد الشركات المدرجة فى البورصة المصرية . </p>
          <a href="?page=aboutus" class="btn-primary-link more-detail"><i class="fa fa-hand-o-right"></i> قراءة المزيد</a>
          <h2>Follow Us</h2>
          <hr>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          ...
          <ul class="use-slt-link col-md-6 col-sm-6 col-xs-12">
            ...
            <li><a href="?page=singlecategory&id=h9W4eEkVDJmZn6LLgcGBnOvOX5vNYzHvEOHA3yRJWbw"><i class="fa fa-hand-o-left"></i>&nbsp;&nbsp;فن البيع</a></li>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <form class="form-alt">
            <div class="form-group">
              <input type="text" placeholder="الأسم :-" required class="form-control">
            </div>
            <div class="form-group">
              <input type="text" placeholder="البريد الإلكترونى :-" required class="form-control">
            </div>
            <div class="form-group">
              <textarea placeholder="الرساله :-" required class="form-control"></textarea>
            </div>
            <div class="form-group">
              <button type="submit" class="btn-quote">ارسل الأن</button>
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12">
          <p class="text-xs-center">2016 - كامل الحقوق محفوظة لشركة موجة </p>
        </div>
