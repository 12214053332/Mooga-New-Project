...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-lg-8 col-xs-12 col-sm-12 center-table">
            ...
            <p class="grey-font md-font text-center">إبدأ رحلتك مع منصة موجة  بتسجيل الدخول أو تفعيل إشتراكك الذي كونته</p>
                    ...
                    <div role="tabpanel" class="col-md-12 col-lg-12 col-xs-12 col-sm-12 tab-pane <?php if ($currentpage=="login"){echo "active";} ?> dark-grey" id="login">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-lg-10 col-xs-11 col-sm-11 center-table">
                                <h2 class="full-lines sm-font"><span class="black-font">أو من خلال حسابك</span></h2>
                            </div>
                                        ...
                                        <div class="form-group col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                            <div class="col-md-10 col-lg-10 col-xs-11 col-sm-11 center-table">
                                                ...
                                                <div class="checkbox center-form-text">
                                                    ...
                                                    <label >
                                                        <input type="checkbox"  id="agree" name="agree" required><span class="asterisc">*</span>أوافق على كافة <a target="_blank" href="?page=terms">الشروط والأحكام</a> اللازمة للتسجيل في الموقع
                                                    </label>
                                                </div>
