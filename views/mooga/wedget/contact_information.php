                                <div class="col-lg-12 col-md-12  col-xs-12 col-sm-12">
									...
									<div class="form-group col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <input type="text" class="form-control" id="contact_name" name="contact_name" placeholder=""   value="<?php printvalue('contact_name'); ?>">
									...
									<div class="form-group col-lg-6 col-md-6 col-xs-12 col-sm-12" id="contact_section">
										...
										<div class="col-lg-8 col-md-8 col-xs-8 col-sm-8">
                                            <input type="number" class="form-control" id="contact_phone" maxlength="11"  minlength="9" name="contact_phone" placeholder=""   value="<?php printvalue('contact_phone'); ?>">
