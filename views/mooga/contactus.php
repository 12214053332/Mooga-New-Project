        ...
        <div class="col-xs-12 col-lg-8 col-sm-12">
          <form class="form-float form-alt">
            <div class="row">
              ...
              <div class="form-group col-md-9 col-lg-9 col-sm-9 col-xs-9"> <span class="from-input-ic"><i class="fa fa-user"></i></span>
                <input type="text" class="form-control" id="name" name="name" placeholder="" value="">
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6"> <span class="from-input-ic"><i class="fa fa-phone"></i></span>
                <input class="form-control" required="" placeholder="Contact Number" type="text">
              </div>
              ...
              <div class="media-body">
                ...
                <div class="lt-co-blok-text">
                  ...
                  <p class="lt-bdr-two"><b>IND</b> :- + 001 245 0154<br>
                    <b>E-Mail</b> :- <a href="mailto:directorylisting@gmail.com">directorylisting@gmail.com</a><br>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="media media-iconic">
              <div class="media-body">
                ...
                <div class="lt-co-blok-text">
                  ...
                  <p class="lt-bdr-three"><b>Mon</b> :- Sat :- 9am - 6pm</p>
                </div>
              </div>
            </div>
          </div>
