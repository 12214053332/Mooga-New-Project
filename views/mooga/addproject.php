                        ...
                        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 ">
                            <div class="col-md-12 col-lg-12 col-xs-10 col-sm-10 center-table">
								...
								<div id="addproject-response"> </div>
								   <div class="form-group">
                                        <button class="btn orange-btn" name="submit"><?php if (  getvalue('id')!="")echo "تعديل";else echo"حفظ"?></button>
                                    </div>
	                        ...
	                        <!-- contact information -->		
									...
									<div class="form-group col-lg-6 col-md-6 col-xs-12 col-sm-12" >
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										<input type="number" id="budget"  name="budget" placeholder="" class="form-control" value="<?php printvalue('budget'); ?>">
									...
									<div class="form-group col-lg-12 col-md-12 col-xs-12 col-sm-12" id="needdescription">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <textarea type="text" class="form-control" id="needdescription"  name="needdescription" placeholder=""  ><?php printvalue('needdescription'); ?></textarea>
                                        </div>
                                    </div>
