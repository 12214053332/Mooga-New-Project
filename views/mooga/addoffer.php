    ...
    <div class="row">  
        <div class="col-lg-12 col-xs-12 col-md-12 col-xs-12 def-padding">
            <div class="col-md-10 col-lg-10 col-xs-12 col-sm-12 center-table">
                <h2 class="full-lines sm-font"><span class="blue-font"><?php if (getvalue('id')!="")echo "تعديل عرض";else echo"اضف عرض جديد"?></span></h2>
				<?php if ($user->phone!=""){ ?>  
                        ...
                        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 ">
                            <div class="col-md-10 col-lg-10 col-xs-10 col-sm-10 center-table">
								...
								<input type="hidden" name="record" value="<?php printvalue('id') ?>">
									...
									<div class="form-group col-md-4 col-lg-4 col-xs-12 col-sm-12 <?php if(!(isset($_GET['action'])&&$_GET['action']=='edit')){?>hidden<?php }?>">
