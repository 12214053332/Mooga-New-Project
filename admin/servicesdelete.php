...
<?php if ($services->name->Visible) { // name ?>
		<th><span id="elh_services_name" class="services_name"><?php echo $services->name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($services->approved->Visible) { // approved ?>
		<th><span id="elh_services_approved" class="services_approved"><?php echo $services->approved->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($services->name->Visible) { // name ?>
		<td<?php echo $services->name->CellAttributes() ?>>
<span id="el<?php echo $services_delete->RowCnt ?>_services_name" class="services_name">
...
<?php } ?>
<?php if ($services->approved->Visible) { // approved ?>
		<td<?php echo $services->approved->CellAttributes() ?>>
<span id="el<?php echo $services_delete->RowCnt ?>_services_approved" class="services_approved">
