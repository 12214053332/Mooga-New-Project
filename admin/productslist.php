...
<?php
	...
	if ($products->CurrentAction == "" && $products_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$products_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<?php if ($products->id->Visible) { // id ?>
	<?php if ($products->SortUrl($products->id) == "") { ?>
		<th data-name="id"><div id="elh_products_id" class="products_id"><div class="ewTableHeaderCaption"><?php echo $products->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->id) ?>',1);"><div id="elh_products_id" class="products_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($products->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($products->user_id->Visible) { // user_id ?>
	<?php if ($products->SortUrl($products->user_id) == "") { ?>
		<th data-name="user_id"><div id="elh_products_user_id" class="products_user_id"><div class="ewTableHeaderCaption"><?php echo $products->user_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->user_id) ?>',1);"><div id="elh_products_user_id" class="products_user_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->user_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($products->user_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->user_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($products->name->Visible) { // name ?>
	<?php if ($products->SortUrl($products->name) == "") { ?>
		<th data-name="name"><div id="elh_products_name" class="products_name"><div class="ewTableHeaderCaption"><?php echo $products->name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->name) ?>',1);"><div id="elh_products_name" class="products_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($products->name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($products->description->Visible) { // description ?>
	<?php if ($products->SortUrl($products->description) == "") { ?>
		<th data-name="description"><div id="elh_products_description" class="products_description"><div class="ewTableHeaderCaption"><?php echo $products->description->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="description"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->description) ?>',1);"><div id="elh_products_description" class="products_description">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->description->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($products->description->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->description->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($products->picpath->Visible) { // picpath ?>
	<?php if ($products->SortUrl($products->picpath) == "") { ?>
		<th data-name="picpath"><div id="elh_products_picpath" class="products_picpath"><div class="ewTableHeaderCaption"><?php echo $products->picpath->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="picpath"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->picpath) ?>',1);"><div id="elh_products_picpath" class="products_picpath">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->picpath->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($products->picpath->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->picpath->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($products->createdtime->Visible) { // createdtime ?>
	<?php if ($products->SortUrl($products->createdtime) == "") { ?>
		<th data-name="createdtime"><div id="elh_products_createdtime" class="products_createdtime"><div class="ewTableHeaderCaption"><?php echo $products->createdtime->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="createdtime"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->createdtime) ?>',1);"><div id="elh_products_createdtime" class="products_createdtime">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->createdtime->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($products->createdtime->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->createdtime->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($products->modifiedtime->Visible) { // modifiedtime ?>
	<?php if ($products->SortUrl($products->modifiedtime) == "") { ?>
		<th data-name="modifiedtime"><div id="elh_products_modifiedtime" class="products_modifiedtime"><div class="ewTableHeaderCaption"><?php echo $products->modifiedtime->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="modifiedtime"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->modifiedtime) ?>',1);"><div id="elh_products_modifiedtime" class="products_modifiedtime">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->modifiedtime->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($products->modifiedtime->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->modifiedtime->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($products->id->Visible) { // id ?>
		<td data-name="id"<?php echo $products->id->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_id" class="products_id">
<span<?php echo $products->id->ViewAttributes() ?>>
<?php echo $products->id->ListViewValue() ?></span>
</span>
<a id="<?php echo $products_list->PageObjName . "_row_" . $products_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($products->user_id->Visible) { // user_id ?>
		<td data-name="user_id"<?php echo $products->user_id->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_user_id" class="products_user_id">
<span<?php echo $products->user_id->ViewAttributes() ?>>
<?php echo $products->user_id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($products->name->Visible) { // name ?>
		<td data-name="name"<?php echo $products->name->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_name" class="products_name">
<span<?php echo $products->name->ViewAttributes() ?>>
<?php echo $products->name->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($products->description->Visible) { // description ?>
		<td data-name="description"<?php echo $products->description->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_description" class="products_description">
<span<?php echo $products->description->ViewAttributes() ?>>
<?php echo $products->description->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($products->picpath->Visible) { // picpath ?>
		<td data-name="picpath"<?php echo $products->picpath->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_picpath" class="products_picpath">
<span<?php echo $products->picpath->ViewAttributes() ?>>
<?php echo $products->picpath->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($products->createdtime->Visible) { // createdtime ?>
		<td data-name="createdtime"<?php echo $products->createdtime->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_createdtime" class="products_createdtime">
<span<?php echo $products->createdtime->ViewAttributes() ?>>
<?php echo $products->createdtime->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($products->modifiedtime->Visible) { // modifiedtime ?>
		<td data-name="modifiedtime"<?php echo $products->modifiedtime->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_modifiedtime" class="products_modifiedtime">
<span<?php echo $products->modifiedtime->ViewAttributes() ?>>
<?php echo $products->modifiedtime->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
