...
define("EW_PROJECT_NAME", "mooga", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{5101AD41-0E34-4393-9492-7002723D723A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'sC5l79sjy1vm9VtN', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/mooga.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "crmkhepr_mooga", "pass" => "Almoasher123", "db" => "crmkhepr_mooga", "qs" => "`", "qe" => "`");
...
define("EW_UPLOAD_DEST_PATH", "../assets/uploads/blog/", TRUE); // Upload destination path (relative to app root)
