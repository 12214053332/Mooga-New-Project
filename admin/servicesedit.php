	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($services->approved->FldErrMsg()) ?>");
...
<input type="hidden" data-table="services" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($services->id->CurrentValue) ?>">
<?php echo $services->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($services->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_services_name" for="x_name" class="col-sm-2 control-label ewLabel"><?php echo $services->name->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $services->name->CellAttributes() ?>>
<span id="el_services_name">
<input type="text" data-table="services" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($services->name->getPlaceHolder()) ?>" value="<?php echo $services->name->EditValue ?>"<?php echo $services->name->EditAttributes() ?>>
</span>
<?php echo $services->name->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($services->approved->Visible) { // approved ?>
	<div id="r_approved" class="form-group">
		<label id="elh_services_approved" for="x_approved" class="col-sm-2 control-label ewLabel"><?php echo $services->approved->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $services->approved->CellAttributes() ?>>
<span id="el_services_approved">
<input type="text" data-table="services" data-field="x_approved" name="x_approved" id="x_approved" size="30" placeholder="<?php echo ew_HtmlEncode($services->approved->getPlaceHolder()) ?>" value="<?php echo $services->approved->EditValue ?>"<?php echo $services->approved->EditAttributes() ?>>
</span>
<?php echo $services->approved->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
