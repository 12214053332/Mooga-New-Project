...
femployeesview.ValidateRequired = true;
<?php } else { ?>
femployeesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
femployeesview.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if (!isset($employees_view->Pager)) $employees_view->Pager = new cPrevNextPager($employees_view->StartRec, $employees_view->DisplayRecs, $employees_view->TotalRecs) ?>
<?php if ($employees_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $employees_view->PageUrl() ?>start=<?php echo $employees_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($employees_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $employees_view->PageUrl() ?>start=<?php echo $employees_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $employees_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($employees_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $employees_view->PageUrl() ?>start=<?php echo $employees_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($employees_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $employees_view->PageUrl() ?>start=<?php echo $employees_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<?php if ($employees->username->Visible) { // username ?>
	<tr id="r_username">
		<td><span id="elh_employees_username"><?php echo $employees->username->FldCaption() ?></span></td>
...
<?php if ($employees->password->Visible) { // password ?>
	<tr id="r_password">
		<td><span id="elh_employees_password"><?php echo $employees->password->FldCaption() ?></span></td>
...
<?php echo $employees->password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($employees->UserLevel->Visible) { // UserLevel ?>
	<tr id="r_UserLevel">
		<td><span id="elh_employees_UserLevel"><?php echo $employees->UserLevel->FldCaption() ?></span></td>
...
<?php echo $employees->UserLevel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($employees->report_level->Visible) { // report_level ?>
	<tr id="r_report_level">
		<td><span id="elh_employees_report_level"><?php echo $employees->report_level->FldCaption() ?></span></td>
...
<?php echo $employees->report_level->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
