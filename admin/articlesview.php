...
$articles_view = NULL; // Initialize page object first

class carticles_view extends carticles {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "articleslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "articleslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($articles_view)) $articles_view = new carticles_view();

// Page init
$articles_view->Page_Init();

// Page main
$articles_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$articles_view->Page_Render();
?>
...
var CurrentForm = farticlesview = new ew_Form("farticlesview", "view");

// Form_CustomValidate event
farticlesview.Form_CustomValidate = 
...
farticlesview.ValidateRequired = true;
<?php } else { ?>
farticlesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
farticlesview.Lists["x_category_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
farticlesview.Lists["x_author_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php } ?>
<?php $articles_view->ExportOptions->Render("body") ?>
<?php
	foreach ($articles_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($articles->Export == "") { ?>
...
<?php } ?>
<?php $articles_view->ShowPageHeader(); ?>
<?php
$articles_view->ShowMessage();
?>
<?php if ($articles->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($articles_view->Pager)) $articles_view->Pager = new cPrevNextPager($articles_view->StartRec, $articles_view->DisplayRecs, $articles_view->TotalRecs) ?>
<?php if ($articles_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($articles_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $articles_view->PageUrl() ?>start=<?php echo $articles_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($articles_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $articles_view->PageUrl() ?>start=<?php echo $articles_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $articles_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($articles_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $articles_view->PageUrl() ?>start=<?php echo $articles_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($articles_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $articles_view->PageUrl() ?>start=<?php echo $articles_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $articles_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="farticlesview" id="farticlesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($articles_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $articles_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="articles">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($articles->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_articles_id"><?php echo $articles->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $articles->id->CellAttributes() ?>>
<span id="el_articles_id">
<span<?php echo $articles->id->ViewAttributes() ?>>
<?php echo $articles->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->category_id->Visible) { // category_id ?>
	<tr id="r_category_id">
		<td><span id="elh_articles_category_id"><?php echo $articles->category_id->FldCaption() ?></span></td>
...
<?php echo $articles->category_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_articles_name"><?php echo $articles->name->FldCaption() ?></span></td>
...
<?php echo $articles->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->description->Visible) { // description ?>
	<tr id="r_description">
		<td><span id="elh_articles_description"><?php echo $articles->description->FldCaption() ?></span></td>
...
<?php echo $articles->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->picpath->Visible) { // picpath ?>
	<tr id="r_picpath">
		<td><span id="elh_articles_picpath"><?php echo $articles->picpath->FldCaption() ?></span></td>
		<td data-name="picpath"<?php echo $articles->picpath->CellAttributes() ?>>
<span id="el_articles_picpath">
<span>
<?php echo ew_GetFileViewTag($articles->picpath, $articles->picpath->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($articles->article_date->Visible) { // article_date ?>
	<tr id="r_article_date">
		<td><span id="elh_articles_article_date"><?php echo $articles->article_date->FldCaption() ?></span></td>
...
<?php echo $articles->article_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->author_id->Visible) { // author_id ?>
	<tr id="r_author_id">
		<td><span id="elh_articles_author_id"><?php echo $articles->author_id->FldCaption() ?></span></td>
...
<?php echo $articles->author_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->views->Visible) { // views ?>
	<tr id="r_views">
		<td><span id="elh_articles_views"><?php echo $articles->views->FldCaption() ?></span></td>
...
<?php echo $articles->views->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->public->Visible) { // public ?>
	<tr id="r_public">
		<td><span id="elh_articles_public"><?php echo $articles->public->FldCaption() ?></span></td>
		<td data-name="public"<?php echo $articles->public->CellAttributes() ?>>
<span id="el_articles_public">
<span<?php echo $articles->public->ViewAttributes() ?>>
<?php echo $articles->public->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($articles->public_title->Visible) { // public_title ?>
	<tr id="r_public_title">
		<td><span id="elh_articles_public_title"><?php echo $articles->public_title->FldCaption() ?></span></td>
...
<?php echo $articles->public_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
