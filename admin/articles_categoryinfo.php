...
//
// Table class for articles_category
//
class carticles_category extends cTable {
	var $id;
	var $name;
	var $picpath;
	...
	function __construct() {
		...
		$this->TableVar = 'articles_category';
		$this->TableName = 'articles_category';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`articles_category`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('articles_category', 'articles_category', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('articles_category', 'articles_category', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['name'] = &$this->name;

		// picpath
		$this->picpath = new cField('articles_category', 'articles_category', 'x_picpath', 'picpath', '`picpath`', '`picpath`', 200, -1, TRUE, '`picpath`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`articles_category`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "articles_categorylist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("articles_categoryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("articles_categoryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "articles_categoryadd.php?" . $this->UrlParm($parm);
		else
			$url = "articles_categoryadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("articles_categoryedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("articles_categoryadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("articles_categorydelete.php", $this->UrlParm());
	}
