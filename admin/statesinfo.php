...
//
// Table class for states
//
class cstates extends cTable {
	var $id;
	var $name;
	var $country_id;
	var $arab_name;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('states', 'states', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('states', 'states', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['name'] = &$this->name;

		// country_id
		$this->country_id = new cField('states', 'states', 'x_country_id', 'country_id', '`country_id`', '`country_id`', 3, -1, FALSE, '`country_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->country_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['country_id'] = &$this->country_id;

		// arab_name
		$this->arab_name = new cField('states', 'states', 'x_arab_name', 'arab_name', '`arab_name`', '`arab_name`', 200, -1, FALSE, '`arab_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`states`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("statesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("statesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "statesadd.php?" . $this->UrlParm($parm);
		else
			$url = "statesadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("statesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("statesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("statesdelete.php", $this->UrlParm());
	}
