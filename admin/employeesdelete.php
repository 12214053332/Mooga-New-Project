...
femployeesdelete.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
if ($employees_delete->Recordset = $employees_delete->LoadRecordset())
	$employees_deleteTotalRecs = $employees_delete->Recordset->RecordCount(); // Get record count
if ($employees_deleteTotalRecs <= 0) { // No record found, exit
	if ($employees_delete->Recordset)
...
<?php if ($employees->id->Visible) { // id ?>
		<th><span id="elh_employees_id" class="employees_id"><?php echo $employees->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($employees->username->Visible) { // username ?>
		<th><span id="elh_employees_username" class="employees_username"><?php echo $employees->username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($employees->password->Visible) { // password ?>
		<th><span id="elh_employees_password" class="employees_password"><?php echo $employees->password->FldCaption() ?></span></th>
<?php } ?>
<?php if ($employees->UserLevel->Visible) { // UserLevel ?>
		<th><span id="elh_employees_UserLevel" class="employees_UserLevel"><?php echo $employees->UserLevel->FldCaption() ?></span></th>
<?php } ?>
<?php if ($employees->report_level->Visible) { // report_level ?>
		<th><span id="elh_employees_report_level" class="employees_report_level"><?php echo $employees->report_level->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($employees->report_level->Visible) { // report_level ?>
		<td<?php echo $employees->report_level->CellAttributes() ?>>
<span id="el<?php echo $employees_delete->RowCnt ?>_employees_report_level" class="employees_report_level">
