...
class ccountry_list extends ccountry {
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fcountrylistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
...
fcountrylist.ValidateRequired = true;
<?php } else { ?>
fcountrylist.ValidateRequired = false; 
<?php } ?>
...
<?php
	...
	if ($bSelectLimit) {
		if ($country_list->TotalRecs <= 0)
			$country_list->TotalRecs = $country->SelectRecordCount();
	} else {
	...
	if ($country->CurrentAction == "" && $country_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$country_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<form name="fcountrylistsrch" id="fcountrylistsrch" class="form-inline ewForm" action="<?php echo ew_CurrentPage() ?>">
...
<?php if (!isset($country_list->Pager)) $country_list->Pager = new cPrevNextPager($country_list->StartRec, $country_list->DisplayRecs, $country_list->TotalRecs) ?>
...
<?php } ?>
<input type="hidden" name="t" value="country">
<div id="gmp_country" class="<?php if (ew_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php if ($country_list->TotalRecs > 0) { ?>
...
<?php if ($country->id->Visible) { // id ?>
	<?php if ($country->SortUrl($country->id) == "") { ?>
		<th data-name="id"><div id="elh_country_id" class="country_id"><div class="ewTableHeaderCaption"><?php echo $country->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->id) ?>',1);"><div id="elh_country_id" class="country_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($country->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($country->iso->Visible) { // iso ?>
	<?php if ($country->SortUrl($country->iso) == "") { ?>
		<th data-name="iso"><div id="elh_country_iso" class="country_iso"><div class="ewTableHeaderCaption"><?php echo $country->iso->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="iso"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->iso) ?>',1);"><div id="elh_country_iso" class="country_iso">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->iso->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($country->iso->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->iso->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($country->nicename->Visible) { // nicename ?>
	<?php if ($country->SortUrl($country->nicename) == "") { ?>
		<th data-name="nicename"><div id="elh_country_nicename" class="country_nicename"><div class="ewTableHeaderCaption"><?php echo $country->nicename->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nicename"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->nicename) ?>',1);"><div id="elh_country_nicename" class="country_nicename">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->nicename->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($country->nicename->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->nicename->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($country->name->Visible) { // name ?>
	<?php if ($country->SortUrl($country->name) == "") { ?>
		<th data-name="name"><div id="elh_country_name" class="country_name"><div class="ewTableHeaderCaption"><?php echo $country->name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->name) ?>',1);"><div id="elh_country_name" class="country_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($country->name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($country->iso3->Visible) { // iso3 ?>
	<?php if ($country->SortUrl($country->iso3) == "") { ?>
		<th data-name="iso3"><div id="elh_country_iso3" class="country_iso3"><div class="ewTableHeaderCaption"><?php echo $country->iso3->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="iso3"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->iso3) ?>',1);"><div id="elh_country_iso3" class="country_iso3">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->iso3->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($country->iso3->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->iso3->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($country->numcode->Visible) { // numcode ?>
	<?php if ($country->SortUrl($country->numcode) == "") { ?>
		<th data-name="numcode"><div id="elh_country_numcode" class="country_numcode"><div class="ewTableHeaderCaption"><?php echo $country->numcode->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="numcode"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->numcode) ?>',1);"><div id="elh_country_numcode" class="country_numcode">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->numcode->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($country->numcode->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->numcode->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($country->code->Visible) { // code ?>
	<?php if ($country->SortUrl($country->code) == "") { ?>
		<th data-name="code"><div id="elh_country_code" class="country_code"><div class="ewTableHeaderCaption"><?php echo $country->code->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="code"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->code) ?>',1);"><div id="elh_country_code" class="country_code">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->code->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($country->code->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->code->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($country->arab_name->Visible) { // arab_name ?>
	<?php if ($country->SortUrl($country->arab_name) == "") { ?>
		<th data-name="arab_name"><div id="elh_country_arab_name" class="country_arab_name"><div class="ewTableHeaderCaption"><?php echo $country->arab_name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="arab_name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->arab_name) ?>',1);"><div id="elh_country_arab_name" class="country_arab_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $country->arab_name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($country->arab_name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($country->arab_name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($country->id->Visible) { // id ?>
		<td data-name="id"<?php echo $country->id->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_id" class="country_id">
<span<?php echo $country->id->ViewAttributes() ?>>
<?php echo $country->id->ListViewValue() ?></span>
</span>
<a id="<?php echo $country_list->PageObjName . "_row_" . $country_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($country->iso->Visible) { // iso ?>
		<td data-name="iso"<?php echo $country->iso->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_iso" class="country_iso">
<span<?php echo $country->iso->ViewAttributes() ?>>
<?php echo $country->iso->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($country->nicename->Visible) { // nicename ?>
		<td data-name="nicename"<?php echo $country->nicename->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_nicename" class="country_nicename">
<span<?php echo $country->nicename->ViewAttributes() ?>>
<?php echo $country->nicename->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($country->name->Visible) { // name ?>
		<td data-name="name"<?php echo $country->name->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_name" class="country_name">
<span<?php echo $country->name->ViewAttributes() ?>>
<?php echo $country->name->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($country->iso3->Visible) { // iso3 ?>
		<td data-name="iso3"<?php echo $country->iso3->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_iso3" class="country_iso3">
<span<?php echo $country->iso3->ViewAttributes() ?>>
<?php echo $country->iso3->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($country->numcode->Visible) { // numcode ?>
		<td data-name="numcode"<?php echo $country->numcode->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_numcode" class="country_numcode">
<span<?php echo $country->numcode->ViewAttributes() ?>>
<?php echo $country->numcode->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($country->code->Visible) { // code ?>
		<td data-name="code"<?php echo $country->code->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_code" class="country_code">
<span<?php echo $country->code->ViewAttributes() ?>>
<?php echo $country->code->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($country->arab_name->Visible) { // arab_name ?>
		<td data-name="arab_name"<?php echo $country->arab_name->CellAttributes() ?>>
<span id="el<?php echo $country_list->RowCnt ?>_country_arab_name" class="country_arab_name">
<span<?php echo $country->arab_name->ViewAttributes() ?>>
<?php echo $country->arab_name->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
