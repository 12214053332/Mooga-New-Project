...
$articles_picpath_blobview = NULL; // Initialize page object first

class carticles_picpath_blobview extends carticles {
	...
	// Page object name
	var $PageObjName = 'articles_picpath_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'articles');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('articles', 'x_picpath');
...
// Create page object
if (!isset($articles_picpath_blobview)) $articles_picpath_blobview = new carticles_picpath_blobview();

// Page init
$articles_picpath_blobview->Page_Init();

// Page main
$articles_picpath_blobview->Page_Main();
?>
<?php
$articles_picpath_blobview->Page_Terminate();
?>
