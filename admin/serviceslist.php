...
<?php if ($services->id->Visible) { // id ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($services->name->Visible) { // name ?>
	<?php if ($services->SortUrl($services->name) == "") { ?>
		<th data-name="name"><div id="elh_services_name" class="services_name"><div class="ewTableHeaderCaption"><?php echo $services->name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->name) ?>',1);"><div id="elh_services_name" class="services_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($services->name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($services->approved->Visible) { // approved ?>
	<?php if ($services->SortUrl($services->approved) == "") { ?>
		<th data-name="approved"><div id="elh_services_approved" class="services_approved"><div class="ewTableHeaderCaption"><?php echo $services->approved->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="approved"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->approved) ?>',1);"><div id="elh_services_approved" class="services_approved">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->approved->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($services->approved->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->approved->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $services_list->PageObjName . "_row_" . $services_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($services->name->Visible) { // name ?>
		<td data-name="name"<?php echo $services->name->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_name" class="services_name">
<span<?php echo $services->name->ViewAttributes() ?>>
<?php echo $services->name->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($services->approved->Visible) { // approved ?>
		<td data-name="approved"<?php echo $services->approved->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_approved" class="services_approved">
<span<?php echo $services->approved->ViewAttributes() ?>>
<?php echo $services->approved->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
