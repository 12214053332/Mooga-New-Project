...
$projects_view_report = NULL;

//
// Table class for projects_view_report
//
class cprojects_view_report extends cTable {
	var $id;
	var $name;
	var $createdtime;
	var $views;
	...
	function __construct() {
		...
		$this->TableVar = 'projects_view_report';
		$this->TableName = 'projects_view_report';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`projects_view_report`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('projects_view_report', 'projects_view_report', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('projects_view_report', 'projects_view_report', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['name'] = &$this->name;

		// createdtime
		$this->createdtime = new cField('projects_view_report', 'projects_view_report', 'x_createdtime', 'createdtime', '`createdtime`', 'DATE_FORMAT(`createdtime`, \'%Y/%m/%d\')', 135, 5, FALSE, '`createdtime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdtime->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['createdtime'] = &$this->createdtime;

		// views
		$this->views = new cField('projects_view_report', 'projects_view_report', 'x_views', 'views', '`views`', '`views`', 20, -1, FALSE, '`views`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->views->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['views'] = &$this->views;

		// unregister_vistors
		$this->unregister_vistors = new cField('projects_view_report', 'projects_view_report', 'x_unregister_vistors', 'unregister_vistors', '`unregister_vistors`', '`unregister_vistors`', 20, -1, FALSE, '`unregister_vistors`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// register_vistors
		$this->register_vistors = new cField('projects_view_report', 'projects_view_report', 'x_register_vistors', 'register_vistors', '`register_vistors`', '`register_vistors`', 20, -1, FALSE, '`register_vistors`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->unregister_users_phone = new cField('projects_view_report', 'projects_view_report', 'x_unregister_users_phone', 'unregister_users_phone', '`unregister_users_phone`', '`unregister_users_phone`', 20, -1, FALSE, '`unregister_users_phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->register_users_phone = new cField('projects_view_report', 'projects_view_report', 'x_register_users_phone', 'register_users_phone', '`register_users_phone`', '`register_users_phone`', 20, -1, FALSE, '`register_users_phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`projects_view_report`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "projects_view_reportlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("projects_view_reportview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("projects_view_reportview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "projects_view_reportadd.php?" . $this->UrlParm($parm);
		else
			$url = "projects_view_reportadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("projects_view_reportedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("projects_view_reportadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("projects_view_reportdelete.php", $this->UrlParm());
	}
