...
class cproducts_edit extends cproducts {
	...
	function ValidateForm() {
		...
		if (!$this->modifiedtime->FldIsDetailKey && !is_null($this->modifiedtime->FormValue) && $this->modifiedtime->FormValue == "") {
			ew_AddMessage($gsFormError, str_replace("%s", $this->modifiedtime->FldCaption(), $this->modifiedtime->ReqErrMsg));
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// modifiedtime
			$this->modifiedtime->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->modifiedtime->CurrentValue, 5), ew_CurrentDate(), $this->modifiedtime->ReadOnly);
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($products->user_id->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_createdtime");
			if (elm && !ew_CheckDate(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($products->createdtime->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_modifiedtime");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $products->modifiedtime->FldCaption(), $products->modifiedtime->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_modifiedtime");
			if (elm && !ew_CheckDate(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($products->modifiedtime->FldErrMsg()) ?>");
...
<?php if (!isset($products_edit->Pager)) $products_edit->Pager = new cPrevNextPager($products_edit->StartRec, $products_edit->DisplayRecs, $products_edit->TotalRecs) ?>
...
<?php if ($products->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_products_id" class="col-sm-2 control-label ewLabel"><?php echo $products->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $products->id->CellAttributes() ?>>
<span id="el_products_id">
<span<?php echo $products->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $products->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="products" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($products->id->CurrentValue) ?>">
<?php echo $products->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($products->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_products_user_id" for="x_user_id" class="col-sm-2 control-label ewLabel"><?php echo $products->user_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $products->user_id->CellAttributes() ?>>
<span id="el_products_user_id">
<input type="text" data-table="products" data-field="x_user_id" name="x_user_id" id="x_user_id" size="30" placeholder="<?php echo ew_HtmlEncode($products->user_id->getPlaceHolder()) ?>" value="<?php echo $products->user_id->EditValue ?>"<?php echo $products->user_id->EditAttributes() ?>>
</span>
<?php echo $products->user_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($products->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_products_name" for="x_name" class="col-sm-2 control-label ewLabel"><?php echo $products->name->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $products->name->CellAttributes() ?>>
<span id="el_products_name">
<input type="text" data-table="products" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="80" placeholder="<?php echo ew_HtmlEncode($products->name->getPlaceHolder()) ?>" value="<?php echo $products->name->EditValue ?>"<?php echo $products->name->EditAttributes() ?>>
</span>
<?php echo $products->name->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($products->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_products_description" for="x_description" class="col-sm-2 control-label ewLabel"><?php echo $products->description->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $products->description->CellAttributes() ?>>
<span id="el_products_description">
<input type="text" data-table="products" data-field="x_description" name="x_description" id="x_description" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($products->description->getPlaceHolder()) ?>" value="<?php echo $products->description->EditValue ?>"<?php echo $products->description->EditAttributes() ?>>
</span>
<?php echo $products->description->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($products->picpath->Visible) { // picpath ?>
	<div id="r_picpath" class="form-group">
		<label id="elh_products_picpath" for="x_picpath" class="col-sm-2 control-label ewLabel"><?php echo $products->picpath->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $products->picpath->CellAttributes() ?>>
<span id="el_products_picpath">
<input type="text" data-table="products" data-field="x_picpath" name="x_picpath" id="x_picpath" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($products->picpath->getPlaceHolder()) ?>" value="<?php echo $products->picpath->EditValue ?>"<?php echo $products->picpath->EditAttributes() ?>>
</span>
<?php echo $products->picpath->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($products->createdtime->Visible) { // createdtime ?>
	<div id="r_createdtime" class="form-group">
		<label id="elh_products_createdtime" for="x_createdtime" class="col-sm-2 control-label ewLabel"><?php echo $products->createdtime->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $products->createdtime->CellAttributes() ?>>
<span id="el_products_createdtime">
<input type="text" data-table="products" data-field="x_createdtime" data-format="5" name="x_createdtime" id="x_createdtime" placeholder="<?php echo ew_HtmlEncode($products->createdtime->getPlaceHolder()) ?>" value="<?php echo $products->createdtime->EditValue ?>"<?php echo $products->createdtime->EditAttributes() ?>>
</span>
<?php echo $products->createdtime->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($products->modifiedtime->Visible) { // modifiedtime ?>
	<div id="r_modifiedtime" class="form-group">
		<label id="elh_products_modifiedtime" for="x_modifiedtime" class="col-sm-2 control-label ewLabel"><?php echo $products->modifiedtime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $products->modifiedtime->CellAttributes() ?>>
<span id="el_products_modifiedtime">
<input type="text" data-table="products" data-field="x_modifiedtime" data-format="5" name="x_modifiedtime" id="x_modifiedtime" placeholder="<?php echo ew_HtmlEncode($products->modifiedtime->getPlaceHolder()) ?>" value="<?php echo $products->modifiedtime->EditValue ?>"<?php echo $products->modifiedtime->EditAttributes() ?>>
</span>
<?php echo $products->modifiedtime->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
