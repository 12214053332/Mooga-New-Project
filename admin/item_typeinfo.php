...
//
// Table class for item_type
//
class citem_type extends cTable {
	var $id;
	var $brand_id;
	var $name;
	var $approved;
	...
	function __construct() {
		...
		$this->TableVar = 'item_type';
		$this->TableName = 'item_type';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`item_type`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('item_type', 'item_type', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// brand_id
		$this->brand_id = new cField('item_type', 'item_type', 'x_brand_id', 'brand_id', '`brand_id`', '`brand_id`', 3, -1, FALSE, '`brand_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->brand_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['brand_id'] = &$this->brand_id;

		// name
		$this->name = new cField('item_type', 'item_type', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['name'] = &$this->name;

		// approved
		$this->approved = new cField('item_type', 'item_type', 'x_approved', 'approved', '`approved`', '`approved`', 3, -1, FALSE, '`approved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`item_type`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("item_typeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("item_typeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "item_typeadd.php?" . $this->UrlParm($parm);
		else
			$url = "item_typeadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("item_typeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("item_typeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("item_typedelete.php", $this->UrlParm());
	}
