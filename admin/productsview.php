...
<?php if (!isset($products_view->Pager)) $products_view->Pager = new cPrevNextPager($products_view->StartRec, $products_view->DisplayRecs, $products_view->TotalRecs) ?>
...
<?php if ($products->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td><span id="elh_products_user_id"><?php echo $products->user_id->FldCaption() ?></span></td>
...
<?php echo $products->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($products->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_products_name"><?php echo $products->name->FldCaption() ?></span></td>
...
<?php echo $products->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($products->description->Visible) { // description ?>
	<tr id="r_description">
		<td><span id="elh_products_description"><?php echo $products->description->FldCaption() ?></span></td>
...
<?php echo $products->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($products->picpath->Visible) { // picpath ?>
	<tr id="r_picpath">
		<td><span id="elh_products_picpath"><?php echo $products->picpath->FldCaption() ?></span></td>
...
<?php echo $products->picpath->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($products->createdtime->Visible) { // createdtime ?>
	<tr id="r_createdtime">
		<td><span id="elh_products_createdtime"><?php echo $products->createdtime->FldCaption() ?></span></td>
...
<?php echo $products->createdtime->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($products->modifiedtime->Visible) { // modifiedtime ?>
	<tr id="r_modifiedtime">
		<td><span id="elh_products_modifiedtime"><?php echo $products->modifiedtime->FldCaption() ?></span></td>
...
<?php echo $products->modifiedtime->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
