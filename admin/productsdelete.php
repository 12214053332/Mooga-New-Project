...
<?php if ($products->id->Visible) { // id ?>
		<th><span id="elh_products_id" class="products_id"><?php echo $products->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->user_id->Visible) { // user_id ?>
		<th><span id="elh_products_user_id" class="products_user_id"><?php echo $products->user_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->name->Visible) { // name ?>
		<th><span id="elh_products_name" class="products_name"><?php echo $products->name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->description->Visible) { // description ?>
		<th><span id="elh_products_description" class="products_description"><?php echo $products->description->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->picpath->Visible) { // picpath ?>
		<th><span id="elh_products_picpath" class="products_picpath"><?php echo $products->picpath->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->createdtime->Visible) { // createdtime ?>
		<th><span id="elh_products_createdtime" class="products_createdtime"><?php echo $products->createdtime->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->modifiedtime->Visible) { // modifiedtime ?>
		<th><span id="elh_products_modifiedtime" class="products_modifiedtime"><?php echo $products->modifiedtime->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $products_delete->RowCnt ?>_products_id" class="products_id">
...
<?php } ?>
<?php if ($products->user_id->Visible) { // user_id ?>
		<td<?php echo $products->user_id->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_user_id" class="products_user_id">
...
<span id="el<?php echo $products_delete->RowCnt ?>_products_name" class="products_name">
...
<span id="el<?php echo $products_delete->RowCnt ?>_products_description" class="products_description">
...
<?php } ?>
<?php if ($products->picpath->Visible) { // picpath ?>
		<td<?php echo $products->picpath->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_picpath" class="products_picpath">
...
<?php } ?>
<?php if ($products->createdtime->Visible) { // createdtime ?>
		<td<?php echo $products->createdtime->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_createdtime" class="products_createdtime">
...
<?php } ?>
<?php if ($products->modifiedtime->Visible) { // modifiedtime ?>
		<td<?php echo $products->modifiedtime->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_modifiedtime" class="products_modifiedtime">
