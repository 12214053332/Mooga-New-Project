...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($services_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $services_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($services_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($services_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $services_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<?php if ($services->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_services_name"><?php echo $services->name->FldCaption() ?></span></td>
		<td data-name="name"<?php echo $services->name->CellAttributes() ?>>
<span id="el_services_name">
<span<?php echo $services->name->ViewAttributes() ?>>
<?php echo $services->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->approved->Visible) { // approved ?>
	<tr id="r_approved">
		<td><span id="elh_services_approved"><?php echo $services->approved->FldCaption() ?></span></td>
		<td data-name="approved"<?php echo $services->approved->CellAttributes() ?>>
<span id="el_services_approved">
<span<?php echo $services->approved->ViewAttributes() ?>>
<?php echo $services->approved->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
