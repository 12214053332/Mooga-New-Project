...
class cproducts extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('products', 'products', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// user_id
		$this->user_id = new cField('products', 'products', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 20, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// name
		$this->name = new cField('products', 'products', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('products', 'products', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['description'] = &$this->description;

		// picpath
		$this->picpath = new cField('products', 'products', 'x_picpath', 'picpath', '`picpath`', '`picpath`', 200, -1, FALSE, '`picpath`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['picpath'] = &$this->picpath;

		// createdtime
		$this->createdtime = new cField('products', 'products', 'x_createdtime', 'createdtime', '`createdtime`', 'DATE_FORMAT(`createdtime`, \'%Y/%m/%d\')', 135, 5, FALSE, '`createdtime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdtime->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['createdtime'] = &$this->createdtime;

		// modifiedtime
		$this->modifiedtime = new cField('products', 'products', 'x_modifiedtime', 'modifiedtime', '`modifiedtime`', 'DATE_FORMAT(`modifiedtime`, \'%Y/%m/%d\')', 135, 5, FALSE, '`modifiedtime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
