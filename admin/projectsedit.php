...
class cprojects_edit extends cprojects {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// project_type_list
			$this->project_type_list->SetDbValueDef($rsnew, $this->project_type_list->CurrentValue, NULL, $this->project_type_list->ReadOnly);

			// project_field_list
			$this->project_field_list->SetDbValueDef($rsnew, $this->project_field_list->CurrentValue, NULL, $this->project_field_list->ReadOnly);
			...
			// stage_list
			$this->stage_list->SetDbValueDef($rsnew, $this->stage_list->CurrentValue, NULL, $this->stage_list->ReadOnly);

			// project_product_list
			$this->project_product_list->SetDbValueDef($rsnew, $this->project_product_list->CurrentValue, NULL, $this->project_product_list->ReadOnly);

			// project_service_list
			$this->project_service_list->SetDbValueDef($rsnew, $this->project_service_list->CurrentValue, NULL, $this->project_service_list->ReadOnly);

			// needagent
			$this->needagent->SetDbValueDef($rsnew, $this->needagent->CurrentValue, NULL, $this->needagent->ReadOnly);

			// needpartner
			$this->needpartner->SetDbValueDef($rsnew, $this->needpartner->CurrentValue, NULL, $this->needpartner->ReadOnly);

			// needclose
			$this->needclose->SetDbValueDef($rsnew, $this->needclose->CurrentValue, NULL, $this->needclose->ReadOnly);

			// closedescription
			$this->closedescription->SetDbValueDef($rsnew, $this->closedescription->CurrentValue, NULL, $this->closedescription->ReadOnly);
			...
			// needfunder
			$this->needfunder->SetDbValueDef($rsnew, $this->needfunder->CurrentValue, 0, $this->needfunder->ReadOnly);

			// needdealer
			$this->needdealer->SetDbValueDef($rsnew, $this->needdealer->CurrentValue, 0, $this->needdealer->ReadOnly);

			// deleted
			$this->deleted->SetDbValueDef($rsnew, $this->deleted->CurrentValue, 0, $this->deleted->ReadOnly);

			// states
			$this->states->SetDbValueDef($rsnew, $this->states->CurrentValue, 0, $this->states->ReadOnly);

			// cities
			$this->cities->SetDbValueDef($rsnew, $this->cities->CurrentValue, 0, $this->cities->ReadOnly);

			// needbuyer
			$this->needbuyer->SetDbValueDef($rsnew, $this->needbuyer->CurrentValue, 0, $this->needbuyer->ReadOnly);

			// needdescription
			$this->needdescription->SetDbValueDef($rsnew, $this->needdescription->CurrentValue, "", $this->needdescription->ReadOnly);

			// contact_type
			$this->contact_type->SetDbValueDef($rsnew, $this->contact_type->CurrentValue, "", $this->contact_type->ReadOnly);
			...
			// pending
			$this->pending->SetDbValueDef($rsnew, $this->pending->CurrentValue, 0, $this->pending->ReadOnly);

			// verified_code
			$this->verified_code->SetDbValueDef($rsnew, $this->verified_code->CurrentValue, 0, $this->verified_code->ReadOnly);

			// country_1
			$this->country_1->SetDbValueDef($rsnew, $this->country_1->CurrentValue, "", $this->country_1->ReadOnly);
...
<?php if (!isset($projects_edit->Pager)) $projects_edit->Pager = new cPrevNextPager($projects_edit->StartRec, $projects_edit->DisplayRecs, $projects_edit->TotalRecs) ?>
<?php if ($projects_edit->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($projects_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $projects_edit->PageUrl() ?>start=<?php echo $projects_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($projects_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $projects_edit->PageUrl() ?>start=<?php echo $projects_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $projects_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($projects_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $projects_edit->PageUrl() ?>start=<?php echo $projects_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($projects_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $projects_edit->PageUrl() ?>start=<?php echo $projects_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $projects_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
