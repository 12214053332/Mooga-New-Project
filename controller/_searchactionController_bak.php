	  ...
	  public function allprojects() 
		  {
			...
			$condition="";
			  if ($stage_list!=""){$condition=$condition. ' and Replace( projects.stage_list,\'"\',\'\' ) in (' . $stage_list .')' ;}
			   if ($frombudget!="" && $tobudget!="" ){$condition=$condition. ' and Replace( projects.stage_list,\'"\',\'\' ) in (' . $stage_list .')' ;}
			  if ($description!=""){$condition=$condition." and (projects.budget between $frombudget and $tobudget) " ;}
